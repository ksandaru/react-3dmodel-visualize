...
//
//                 // location 5
//                 <group ref={myGroup} position={[176.87, 34.45, -172.14]} rotation={[-Math.PI / 2, 0, 0]} scale={20}>
//                     <group ref={group} rotation={[Math.PI / 2, 0, 0]}>
//                         <mesh  geometry={nodes.Object_4014.geometry} material={materials['material.017']}
//                               material-color={changeColor(5).toString() ==='TIGHT' ?  snap.items.greenGeo : snap.items.redGeo}
//                         />
